...
@section('title','Peminjaman - Edit - Operator')
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ url('operator/peminjaman/update/'.$data_edit_detail->id) }}" method="post">
              {{ csrf_field() }}
              {{ method_field('PATCH') }}
              <div class="form-group">
                ...
                <select name="id_pegawai" id="id_pegawai" class="form-control">
                  ...
                  <option value="{{ $value1->id }}" @if($data_edit_peminjaman->id_pegawai == $value1->id) selected @endif>{{ $value1->nama_pegawai }}</option>
                  @endforeach
                </select>
              </div>
              <div class="form-group">
