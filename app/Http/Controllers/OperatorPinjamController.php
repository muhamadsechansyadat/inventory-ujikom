...
class OperatorPinjamController extends Controller
{
    public function index(){
    	$datapeminjaman = DB::table('peminjaman')
    				...
    				->get();            		
    	return view('operator.peminjaman.index', compact('datapeminjaman'));
    }
    ...
    public function create(){
        ...
        // dd($kode_inven);
    	return view('operator.peminjaman.create', compact('pegawai','inventaris'));
    }
    ...
    public function save(Request $request){
    	...
    	if ($request->jumlah > $jumlah) {
			...
			if ($data_stor_peminjaman AND $data_stor_detail AND $update_inventaris) {
				...
				return redirect()->route('operator.peminjaman.index')->with('success', 'Data Berhasil Tersimpan');
			} else {
    ...
    public function edit($id){
        ...
        return view('operator.peminjaman.edit', compact('data_edit_detail','data_edit_peminjaman','data_edit_pegawai','pegawai','inventaris'));
    }
    ...
    public function update(Request $req,$id){
        ...
        if ($input['jumlah'] > $jumlah) {
            ...
            return redirect()->route('operator.peminjaman.index')->with('success', 'Data Berhasil Terupdate');
        }
    }
