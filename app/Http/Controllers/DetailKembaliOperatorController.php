...
class DetailKembaliOperatorController extends Controller
{
	public function index(){
        ...
        // dd($datapeminjaman);
		return view('operator.pengembalian.index', compact('datapeminjaman'));
	}
    ...
    public function save(Request $req,$id){
        ...
        if ($input['baik'] + $input['buruk'] > $jumlah) {
            ...
            return redirect('operator/pengembalian/index')->with('success', 'Data Berhasil Terupdate');
        }else{
